...
const FEATURES = [
  ...
  },
  {
    ...
    accent: "#F59E0B",
    image:
      "https://images.unsplash.com/photo-1616587226960-4a03badbe8bf?w=700&q=80",
  ...
  return (
    ...
    >
        ...
        <div className="max-w-6xl mx-auto px-6 py-24 grid md:grid-cols-2 gap-14 items-center w-full">
          ...
          >
            ...
            >
              Smarter Care,
              <br />
              <span style={{ color: "#7DD3FC", fontStyle: "italic" }}>
                Better Hospitals
              </span>
            </motion.h1>
            ...
            >
              MediCore HMS brings patients, doctors, and administration together
              in one unified platform — making hospital operations simple,
      ...
      <motion.section
        ...
        variants={fadeUp}
      >
        <p className="text-sky-600 text-xs font-semibold uppercase tracking-widest mb-4">
          What We Offer
        </p>
        <h2
        ...
        <p className="text-slate-500 text-base leading-relaxed">
          From a small clinic to a large hospital, MediCore adapts to your needs
          and helps your team deliver great care without the chaos.
        </p>
      </motion.section>
      ...
      >
        ...
        >
          ...
          <p className="text-blue-100 text-base mb-8 max-w-md mx-auto">
            Sign up today and see how MediCore HMS can simplify your hospital's
