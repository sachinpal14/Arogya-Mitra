...
const AppointmentManagement = () => {
  ...
  const mockAppointments = [
    {
      ...
      instructions:
        "Please have your recent ECG reports ready for review during the consultation.",
    },
    {
      id: 2,
      date: "2025-10-12",
    ...
    },
    {
      ...
      provider: {
        ...
        avatar:
          "https://images.unsplash.com/photo-1594824475317-8b7f0c5c0b8e?w=150&h=150&fit=crop&crop=face",
      },
      type: "phone",
      status: "pending",
  ...
  return (
    <div className="min-h-screen bg-surface overflow-hidden flex justify-center w-sceen">
      ...
      <main
        className={`pt-14 healthcare-transition  overflow-hidden fixed w-full   h-full `}
      >
        <div className="p-6">
          {/* Page Header */}
          <div className="mb-2">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-text-secondary ">
                  Schedule appointments, manage your healthcare calendar, and
                  track queue status
                </p>
              </div>
              ...
              <div className="lg:col-span-3  w-full">
                <div className="bg-white rounded-lg  w-[100%] border border-slate-200 healthcare-shadow p-6">
                  ...
                  <div className="text-sm text-text-secondary">
                    Found {filteredProviders?.length} doctor
