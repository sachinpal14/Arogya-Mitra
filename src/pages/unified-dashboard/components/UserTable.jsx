  ...
  return (
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="max-w-7xl mx-auto bg-white shadow-xl rounded-2xl p-6">
        <div className='flex '>
          <button className="flex items-center text-gray-600 hover:text-gray-800 mb-4" onClick={() => window.history.back()}><IoMdArrowBack size={35} className="mr-2 text-xl" /></button>
